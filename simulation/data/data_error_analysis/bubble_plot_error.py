...
set format y "10^{%.0T}"
set ytics 1e-8,1e-1 logscale

set xrange [1.8:36]
set format x "%.0f"
set xtics (0,2,4,8,16,24,32) 


set logscale xy
set grid ytics, xtics, mxtics, mytics

set arrow 1 from 2e0,1e-6 to 4e0,1e-6 nohead
set arrow 2 from 4e0,1e-6 to 2e0,4e-6 nohead
set arrow 3 from 2e0,4e-6 to 2e0,1e-6 nohead 
set label "2" at 2.1e0,1.7e-6
...
plot './err_mid.dat' using 1:2 w lp lt 8 pt 6 ps 2 lw 1 dt 1 title 'Mid-point',\
     './err_imp.dat' using 1:2 w lp lt 8 pt 8 ps 2.5 lw 1 dt 1 title 'Euler impl.'
